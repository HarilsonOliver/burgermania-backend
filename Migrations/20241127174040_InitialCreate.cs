        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescricaoInteira = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioPedidos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsuarioPedidos_Pedidos_PedidoId",
                        column: x => x.PedidoId,
                        principalTable: "Pedidos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsuarioPedidos_Usuarios_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuarioPedidos_PedidoId",
                table: "UsuarioPedidos",
                column: "PedidoId");

            migrationBuilder.CreateIndex(
                name: "IX_UsuarioPedidos_UsuarioId",
                table: "UsuarioPedidos",
                column: "UsuarioId");
        }
